...
async def profile_page(
    ...
    return templates.TemplateResponse(
        "user_profile.html",
        {
            ...
            "current_user": current_user,  # Make sure current_user is passed to the template
            "articles": articles,
...
async def edit_profile_page(
    ...
    if not current_user:
        return templates.TemplateResponse(
            "login_required.html",
            {"request": request, "redirect_to": "/profile/edit"}
        )
...
async def user_profile_page(
    ...
    """
    Render the user profile page by user ID.
    """
    templates = request.app.state.templates
